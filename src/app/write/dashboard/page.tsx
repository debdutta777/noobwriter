      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link href="/write/earnings">
            <Button variant="outline" className="w-full h-auto py-6 text-lg bg-gradient-to-r from-purple-500/10 to-blue-500/10 hover:from-purple-500/20 hover:to-blue-500/20 border-purple-500/20" size="lg">
