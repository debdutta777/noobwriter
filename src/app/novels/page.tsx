    ...
    <div className="container mx-auto px-4 py-10">
      <div className="mb-8">
        <div className="inline-flex items-center gap-2 text-amber-500 mb-3">
          ...
          <span className="text-xs font-semibold uppercase tracking-[0.18em]">Web novels</span>
        </div>
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-2">Novels</h1>
        <p className="text-muted-foreground">Long-form serialized fiction — chapter by chapter.</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-24 rounded-2xl border border-dashed">
          ...
          <h3 className="text-xl font-semibold mb-1">No novels found</h3>
          <p className="text-muted-foreground text-sm">Try adjusting your filters or search term.</p>
        </div>
      ) : (
        <>
          <div className="mb-5 text-sm text-muted-foreground">
            {series.length} novel{series.length !== 1 ? 's' : ''}
          </div>
